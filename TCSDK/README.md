...
<p>Last update : <em>26/04/2022</em><br />
...
<pre><code>implementation project(':core')
implementation 'com.android.support:appcompat-v7:27.1.1'
</code></pre>
...
<pre><code>TCLocation.getInstance(context);
</code></pre>
...
<pre><code>//!\\ Very important while integrating TagCommander
...
<pre><code>TCInstance.addData("#EVENT#", "click");
...
<pre><code>TCAppVars appVars = new TCAppVars();
...
<pre><code>public void SendViewCart()
{
...
<pre><code>product.customProperties.put("Menu", "12");
...
<p>ruby
    -keep class com.tagcommander.lib.*<em> { </em>; }</p>
...
<pre><code>TCInstance.disableSDK();
</code></pre>
...
<pre><code>TCInstance.addPermanentData("#VENDOR_ID#", "UE-55668779-01");
</code></pre>
<p>They can also be removed if necessary.</p>
<pre><code>TCInstance.removePermanentData("#VENDOR_ID#");
</code></pre>
...
<pre><code>TCPredefinedVariables predefVariables = TCPredefinedVariables.getInstance();
...
<hr />
<p>This documentation was generated on 26/04/2022 15:31:20</p>
</body>
</html>